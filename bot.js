...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__General orders__***
**
${s}allbots/لعرض جميع البوتات الي بالسيرفر
...
${s}invinfo <invitelink here> / لمعلومات عن الدعوه
 مثال : invinfo m82n8P
${s}invite-codes/يعرض لك روابط الانفايتات حكك في السيرفر 
${s}cal/اله حاسبة
...
${s}bk / رسالة جماعيه مع
${s}rolebc <everyone or @role> / راسال رساله جماعيه لرتبه محدده
${s}role @user <rank> / لأعطاء رتبة لعضو معين
${s}roleremove @user <rank> / لازالة الرتبة من شخص معين
${s}give all <rank> / لأعطاء رتبة للجميع
${s}give humans <rank> / لأعطاء رتبة للاشخاص فقط
${s}give bots <rank> / لأعطاء رتبة لجميع البوتات
${s}hchannel / اخفاء الشات
${s}schannel / اضهار الشات المخفية
${s}clr <numbr> / مسح الشات بعدد
${s}clear / مسح الشات
${s}mute @user <time> / اعطاء العضو ميوت 
...
${s}temp / لانشاء روم مؤقت
${s}delet <name> / مسح الشات او الرووم فويس
${s}make <number> / ينشا لك الوان مع كم الوان تبي
${s}color <number> / لختيار لون
${s}deletecolors <number> / لحذف الالوان
**
   `,`
        ***__Music orders__***
**
...
const speed = [
              ...
              },
    {
            ...
            "type": "https://www.youtube.com/channel/UCJWnWxOrWMeIQiybbtuqF5w?view_as=subscriber",
        "answers": ["قنات ولف"]
...
const zead = [
   ...
   '*** هي لنبداء  يا صديقي الرعب اذا تخاف راح اقتلك ***',
   '*** المس انفك ثلاث مرات يا حبيبي ***',
   '*** اجري في الشارع لمدة 10 دقائق ***',
   '*** انتا شو اسمك يا صديقي ***',
   '*** طيب اسمك جميل احبه ***',
   '*** امسك خيط واربطو في الشباك ونط من الدور الخامس ***',
'*** انا لست الحوت الازرق كما يدعون ***',
   ...
   '*** هل تحب ولف جود هون صانعني  انا احبه ههههههههه ***',
...
//	console.log('yao: ' + Util.escapeMarkdown(video.thumbnailUrl));
	const song = {
		...
		url: `https://www.youtube.com/channel/UCJWnWxOrWMeIQiybbtuqF5w?view_as=subscriber=${video.id}`
	};//by ,$ ReBeL ء , ??#4777 'CODES SERVER'
	if (!serverQueue) {
